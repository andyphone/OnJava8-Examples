...
public class Blip3 implements Externalizable {
  ...
  public Blip3(String x, int a) {
    System.err.println("Blip3(String x, int a)");
    s = x;
    i = a;
  ...
  throws IOException {
    System.err.println("Blip3.writeExternal");
    // You must do this:
    out.writeObject(s);
    out.writeInt(i);
  }
  ...
  throws IOException, ClassNotFoundException {
    System.err.println("Blip3.readExternal");
    // You must do this:
    s = (String)in.readObject();
    i = in.readInt();
  }
  public static void main(String[] args) {
    System.err.println("Constructing objects:");
    ...
    // Now get it back:
    System.err.println("Recovering b3:");
    try(
